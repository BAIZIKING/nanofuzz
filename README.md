...
- **More types**: Tuples, Unions, unique Arrays/Lists, regex Strings, `null`s, binary data, and select Typescript utility types, like `Record<K,V>`, `Required<T>` and `Partial<T>`.
